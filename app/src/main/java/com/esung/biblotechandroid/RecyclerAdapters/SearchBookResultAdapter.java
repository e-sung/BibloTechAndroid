...
public class SearchBookResultAdapter extends RecyclerView.Adapter<SearchBookResultAdapter.ViewHolder> {
    ...
    @Override
    public SearchBookResultAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SearchBookResultAdapter.ViewHolder holder, int position) {
